...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    is_sent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    onesignal_id: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProduitProduit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    resell: Schema.Attribute.Boolean;
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    titre_selection: Schema.Attribute.String;
    top_produits: Schema.Attribute.Component<'shared.produit', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
